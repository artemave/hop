...
def focus_terminal(
    ...
    *,
    ...
    # Every role — editor included — is a plain kitty role terminal:
    # `ensure_terminal` focuses it if it exists, launches it (shell + its
    # typed-in command) if not.
    ...
    # look up the role's OS window by app_id and direct sway to focus it.
